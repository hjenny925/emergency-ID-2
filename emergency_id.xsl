...
<xsl:template match="/">
    ...
    <head>
        ...
        <style>
            :root { --primary: #94806a; --bg: #c2b09d; --card-white: #dedbd7; --text-main: #5a544d; --accent: #8b4513; }
            ...
            .lang-selector { margin-bottom: 20px; width: 100%; max-width: 380px; }
            select { width: 100%; padding: 12px; border-radius: 12px; background: var(--primary); color: white; font-weight: bold; font-size: 16px; border: 2px solid white; }
            .card { width: 100%; max-width: 380px; background: var(--card-white); border-radius: 25px; box-shadow: 0 15px 35px rgba(0,0,0,0.25); overflow: hidden; }
            .header { background: var(--primary); color: white; padding: 20px; text-align: center; }
            .photo-sec { padding: 20px; text-align: center; }
            .profile-img { width: 120px; height: 150px; object-fit: cover; border: 4px solid #fff; border-radius: 12px; }
            .user-name { color: var(--primary); margin-top: 12px; font-size: 22px; }
            .content { padding: 0 25px 20px; }
            .section-title { font-size: 11px; color: var(--primary); font-weight: 900; margin: 18px 0 8px; border-left: 3px solid var(--primary); padding-left: 8px; text-transform: uppercase; }
            .item { margin-bottom: 10px; border-bottom: 1px solid rgba(133, 122, 110, 0.2); padding-bottom: 5px; }
            .label { font-size: 10px; color: #7a6955; font-weight: bold; display: block; }
            .value { font-size: 15px; color: var(--text-main); font-weight: 600; display: block; }
            .help-box { background: #fff5f5; padding: 12px; border-radius: 12px; border: 1px solid #feb2b2; margin-top: 10px; text-align: center; }
            .help-text { color: #c53030; font-weight: bold; font-style: italic; font-size: 14px; }
            .footer { text-align: center; font-size: 10px; color: #7a6955; padding: 15px; }
        </style>
    </head>
    <body>
        ...
        <div class="card">
            <div class="header"><h1 id="ui-title">緊急個人資訊</h1></div>
            <div class="photo-sec">
                <img src="photo.jpg" class="profile-img" onerror="this.src='https://via.placeholder.com/120x150?text=PHOTO'" />
            ...
            <div class="content">
                ...
                <div class="item"><span class="label" id="lbl-ice">聯絡人</span>
                    <span class="value">
                        <xsl:for-each select="emergency_id/contacts/contact">
                            <xsl:value-of select="@role"/>: <xsl:value-of select="."/><br/>
                        </xsl:for-each>
                    </span>
                </div>
                <div class="help-box"><div class="help-text" id="val-help">"我不舒服，請幫我叫救護車。"</div></div>
            </div>
        ...
        <script>
            const translations = {
                zh: { title: "緊急個人資訊", s1: "基本資料", s2: "醫療資訊", s3: "緊急聯絡", dob: "出生日期", passport: "護照號碼", blood: "血型", allergy: "過敏紀錄", history: "病史", ice: "緊急聯絡人", help: "「我不舒服，請幫我叫救護車。」" },
                en: { title: "EMERGENCY ID", s1: "BASIC INFO", s2: "MEDICAL INFO", s3: "CONTACTS", dob: "Date of Birth", passport: "Passport No.", blood: "Blood Type", allergy: "Allergies", history: "Medical History", ice: "ICE Contact", help: '"I feel unwell. Please call an ambulance."' },
                jp: { title: "緊急医療情報", s1: "基本情報", s2: "医療情報", s3: "緊急連絡先", dob: "生年月日", passport: "パスポート番号", blood: "血液型", allergy: "アレルギー", history: "既往歴", ice: "緊急連絡先", help: "「気分が悪いです。救急車を呼んでください。」" },
