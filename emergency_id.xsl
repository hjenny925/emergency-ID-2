...
<xsl:template match="/">
    ...
    <body>
        <div class="lang-buttons">
            <button class="lang-btn active" onclick="changeLanguage('zh', this)">🇹🇼 中文</button>
            <button class="lang-btn" onclick="changeLanguage('en', this)">🇺🇸 EN</button>
            <button class="lang-btn" onclick="changeLanguage('jp', this)">🇯🇵 JP</button>
            <button class="lang-btn" onclick="changeLanguage('kr', this)">🇰🇷 KR</button>
            <button class="lang-btn" onclick="changeLanguage('vn', this)">🇻🇳 VN</button>
            <button class="lang-btn" onclick="changeLanguage('th', this)">🇹🇭 TH</button>
            <button class="lang-btn" onclick="changeLanguage('fr', this)">🇫🇷 FR</button>
            <button class="lang-btn" onclick="changeLanguage('de', this)">🇩🇪 DE</button>
        </div>
        ...
        <div class="card">
            ...
            <div class="content">
                <div class="section-title" id="sec-basic">Basic Info / 基本資料</div>
                ...
                <div class="section-title" id="sec-medical">Medical / 醫療資訊</div>
                ...
                <div class="section-title" id="sec-contact">Emergency / 緊急聯絡</div>
                <div class="item">
                    <span class="label" id="lbl-ice">聯絡人</span>
                    <span class="value">
            ...
            <div class="footer" id="ui-footer">最後更新: <xsl:value-of select="emergency_id/user_info/last_update"/></div>
        </div>
        ...
        <script>
            ...
            window.onload = () => changeLanguage('zh');
        </script>
    </body>
    </html>
</xsl:template>
